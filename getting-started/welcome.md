# Welcome to AOV.AI Checkout Upsell

AOV.AI helps you increase Average Order Value (AOV) by customizing the Shopify checkout experience — show upsell offers, control payment and delivery methods, and display discount codes, all without leaving checkout.
...
- **Checkout UI Extensions** (Upsell Block, Discount List) — app blocks you add via the Theme Editor
- **Shopify Functions** (Payment & Delivery Customization) — serverless rules that run at checkout evaluation time
