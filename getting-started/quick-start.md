...
- **Shopify Plus?** You can use all features, including Checkout Upsell Block and Discount List.
- **Other plans?** Payment Customization and Delivery Customization are available to you right away — no extra setup needed.

See the **Plans & Requirements** page for the full feature comparison.

## Step 3: Activate the checkout block (Shopify Plus only)

Before creating your first upsell offer, add the AOV.AI block to your checkout theme:

1. Go to **Shopify Admin** → **Online Store** → **Themes** → **Customize**
2. Select **Checkout** from the page dropdown
3. Find **AOV.AI** in the App blocks panel and drag it to your preferred position
4. Click **Save**
...
1. In the app, go to **Offers** → **Create offer** → select **Checkout upsell**
...
Your offer is now live at checkout.
