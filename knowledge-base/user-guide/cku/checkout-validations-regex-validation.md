...
{% hint style="warning" %}
The regex pattern is validated when you save. If the pattern is invalid, you'll see an inline error: _"Invalid regex pattern. Please check your expression."_
{% endhint %}
...
{% hint style="info" %}
When using "Must NOT match" mode, a yellow warning box explains: _"Checkout is blocked if the field value DOES match the pattern (blocklist mode)."_ This helps avoid confusion about the reversed logic.
{% endhint %}
...
**Q: How many rules can I have?** A: You can have up to **25 active validation rules** at once (shared with Custom Rules, Geo Restriction, and Order Limits rules).
