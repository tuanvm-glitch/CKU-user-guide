...
---
description: >-
  Explore how to create tiered reward campaigns based on cart value or item
  quantity to increase average order value.
---
...
* **All Eligible Gifts (Recommended)**: Customer gets _every_ reward unlocked across all tiers.
