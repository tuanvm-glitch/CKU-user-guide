...
---
description: >-
  Learn how to set up the Milestone bar for your Milestone rewards campaign to
  show customers how close they are to earning rewards.
---
...
* `{{nearest_reward}}` – shows the reward name of the _next milestone_
{% endhint %}
