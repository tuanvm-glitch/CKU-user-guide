...
---
description: >-
  Learn how to customize how your discount tiers appear on product pages, making
  them clear and attractive to customers.
---
...
* **Title**: The main heading above the discount widget. Example: _“Get more, save more.”_
* **Description**: Short explanation of the offer. Example: _“Unlock greater savings as you purchase more items.”_
* **Translation**:
...
* Example: _“Add 1 more item to unlock 25% off.”_
...
* If widget colors don’t match your theme, you may see: _“Widget color doesn’t match your theme.”_
...
* “Add to cart” button. Example: _Add to cart_.
* “Item added to your cart” button. Example: _Item added to your cart_.
* “See more” label: expands tier list. Example: _See more_.
* “See less” label: collapses tier list. Example: _See less_.
* “Free” text: label for free gifts. Example: _Free_.
* “Saving” text: label for savings. Example: _Save_.
{% endstep %}
...
* Example: “Save” → _Sparen_ in German.
{% endstep %}
{% endstepper %}
