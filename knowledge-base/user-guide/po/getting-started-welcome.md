...
---
description: >-
  Set up pre-order campaigns to sell products before they're available and
  manage customer expectations with delivery dates and payment options.
---
...
![AOV.ai Pre-Order Dashboard](https://660775721-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FEVi9QELp1WJgWsqrMONK%2Fuploads%2Fgit-blob-0d7f04f514f0d59de14a90665c7d071efd0bdd84%2Fdashboard-framed.png?alt=media)
...
| Guide                                                                 | Description                                                                               |
| --------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| [Campaign List](../manage/campaign-list)                              | View, filter, and manage your pre-order campaigns                                         |
| [Campaign Settings (Step 1)](../pre-order-campaign/campaign-settings) | Configure campaign name, products, pre-order trigger, continue selling, and delivery date |
| [Payment Settings (Step 2)](../pre-order-campaign/payment-settings)   | Choose full or partial payment, set deposit amount                                        |
| [Display Settings (Step 3)](../pre-order-campaign/display-settings)   | Customize button, badge, and messages                                                     |
| [Orders & Reports](../manage/orders)                                  | View, filter, export pre-order reports, and collect payments                              |
