...
---
description: View, filter, and manage your pre-order campaigns
---
...
![Campaign list](https://660775721-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FEVi9QELp1WJgWsqrMONK%2Fuploads%2Fgit-blob-8981d009b62122f8667c611ef68184fbc32a6d93%2Fcampaign-list-framed.png?alt=media)
...
1. [Campaign Settings](../pre-order-campaign/campaign-settings) — name, products, delivery date
2. [Payment Settings](../pre-order-campaign/payment-settings) — full or partial payment
3. [Display Settings](../pre-order-campaign/display-settings) — button, badge, messages
{% endstep %}
