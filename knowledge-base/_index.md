...
- `faq/fg/an-congrat-bar-cho-1-vai-campaign-cu-the.md` — Ẩn congrat bar cho 1 vài campaign cụ thể
- `faq/fg/mc-khong-muon-cho-customer-thay-doi-duoc-so-luong-gift-o-cart-page-hoac-cart-dra.md` — MC không muốn cho customer thay đổi được số lượng Gift ở cart page hoặc cart drawer
- `faq/fg/campaign-khong-work-do-het-luot-use.md` — Campaign không work do hết lượt Use
- `faq/fg/chi-nhan-1-gift-tu-campaign-trong-app-va-order-phai-apply-duoc-discount-tu-shopi.md` — Chỉ nhận 1 Gift từ campaign trong app và Order phải apply được discount từ Shopify
- `faq/fg/buy-x-get-x-cho-phep-nhan-nhieu-gifts-theo-tung-trigger.md` — Buy X Get X - Cho phép nhận nhiều Gifts theo từng trigger    
- `faq/fg/mc-muon-offer-discount-cho-khach-hang-mua-lan-dau.md` — MC muốn offer discount cho khách hàng mua lần đầu 
- `faq/fg/promotion-card-mc-muon-nut-unlock-your-gift-work-nhu-nut-add-to-cart-default-cua.md` — Promotion card: MC muốn nút “unlock your gift” work như nút “add to cart” default của theme. 
- `faq/fg/for-cs-test-store-lam-the-nao-de-hien-local-currency-trong-gift-with-cart-value-.md` — (For CS test store) Làm thế nào để hiện “Local Currency” trong Gift With Cart Value (GWCA) setting? 
- `faq/fg/gift-duoc-set-discount-nhung-van-bi-charge-full-gia-campaign-gwca.md` — Gift được set discount, nhưng vẫn bị charge full giá (Campaign GWCA).
- `faq/fg/gift-with-cart-value-offer-gift-dua-tren-gia-goc-cua-san-pham-thay-vi-gia-sau-di.md` — Gift with cart value offer gift dựa trên giá gốc của sản phẩm thay vì giá sau discount.
- `faq/fg/cac-truong-hop-xay-ra-khi-tao-nhieu-campaign-gift-with-cart-value-gwca-voi-cac-m.md` — Các trường hợp xảy ra khi tạo nhiều campaign Gift With Cart Value (GWCA) với các mốc threshold khác nhau thì app sẽ work như thế nào? 
- `faq/fg/logic-combination-cua-campaigns-discounts-cung-loai.md` — Logic combination của campaigns/discounts cùng loại
- `faq/fg/gift-with-quantity-purchase-logic.md` — Gift with Quantity Purchase logic 
- `faq/fg/ban-chat-cua-campaign-buy-x-get-y-phan-biet-bxgy-voi-gwqa.md` — Bản chất của campaign Buy X get Y - Phân biệt BXGY với GWQa
- `faq/fg/work-flow-cua-bxgy-va-gift-w-quantity-purchase.md` — Work Flow của BXGY và Gift W Quantity Purchase
- `faq/fg/milestone-reward-campaign-combination.md` — Milestone Reward campaign Combination 
- `faq/fg/cac-access-can-xin-khi-campaign-khong-work.md` — Các access cần xin khi campaign không work
- `faq/fg/gift-selection-method-doi-voi-discount-type-cua-gift.md` — Gift selection method đối với discount type của gift
- `faq/fg/milestone-reward-final-price-workflow.md` — Milestone reward - final price workflow 
- `faq/fg/gift-with-quantity-purchase-workflow.md` — Gift with Quantity Purchase workflow 
- `faq/fg/auto-remove-gift-on-checkout-and-prevent-expired-campaign-gifts-from-being-check.md` — Auto remove gift on Checkout and Prevent expired campaign gifts from being checked out (Shopify Plus only) 
- `faq/fg/phan-biet-multiplying-gift-limit-va-multiplying-formula.md` — Phân biệt “Multiplying Gift Limit” và “Multiplying formula” 
- `faq/fg/mc-muon-dung-milestone-bar-de-hien-thi-processing-nhung-ko-muon-no-work.md` — MC muốn dùng Milestone bar để hiển thị processing nhưng ko muốn nó work 
- `faq/fg/phan-biet-campaign-gwca-gift-with-cart-value-va-gwcv-gift-with-collection-value.md` — Phân biệt campaign GWCA (Gift with cart value) và GWCV (Gift with collection value)
- `faq/fg/by-pass-rule-nhung-van-nhan-duoc-gift.md` — By pass rule nhưng vẫn nhận được gift
- `faq/fg/mc-muon-customer-tuy-chon-gift-voi-settings-multiplying.md` — MC muốn customer tuỳ chọn gift với settings Multiplying
- `faq/fg/failed-to-apply-promotion.md` — Failed to apply promotion 
- `faq/fg/khong-add-duoc-app-vao-shopify-pos.md` — Không add được app vào Shopify POS
...
- `faq/bu/fixed-bundle-lam-the-nao-de-xac-dinh-duoc-bundled-products-options-va-variants-t.md` — Fixed Bundle: Làm thế nào để xác định được Bundled Products, Options và Variants trong campaign settings?
- `faq/bu/volume-discount-co-duoc-tu-dong-tang-discount-value-theo-so-luong-cua-product-qu.md` — Volume discount có được tự động tăng “Discount value” theo số lượng của Product quantity ko?
- `faq/bu/doi-vi-tri-hien-thi-cua-currency.md` — Đổi vị trí hiển thị của Currency
- `faq/bu/display-compare-at-price-trong-volume-discount.md` — Display compare-at price trong Volume discount
- `faq/bu/luu-y-khi-tao-template-cho-bundle-builder.md` — Lưu ý khi tạo template cho Bundle Builder 
- `faq/bu/trigger-1-san-pham-trong-2-campaigns-fbt-va-volume-discount.md` — Trigger 1 sản phẩm trong 2 campaigns FBT và Volume discount 
- `faq/bu/cac-issue-thuong-gap-o-mix-match-va-fixed-bundle.md` — Các issue thường gặp ở Mix-match và Fixed bundle
- `faq/bu/san-pham-con-trong-bundle-co-tu-dong-giam-inventory-neu-co-nguoi-mua-hang-ko.md` — Sản phẩm con trong Bundle có tự động giảm inventory nếu có người mua hàng ko? 
- `faq/bu/cach-cart-tips-hoat-dong-tinh-nang-dev-zone-de-doi-flow-cua-cart-tips.md` — Cách Cart Tips hoạt động: Tính năng dev_zone để đổi flow của Cart Tips
- `faq/bu/loi-json-khi-an-add-to-cart-tu-volume-discount-widget.md` — Lỗi JSON khi ấn add to cart từ volume discount widget
- `faq/bu/hien-thi-compare-at-price-cua-tung-san-pham-trong-fbt-thay-vi-chi-hien-moi-o-fin.md` — Hiển thị “Compare at price” của từng sản phẩm trong FBT thay vì chỉ hiện mỗi ở Final total
- `faq/bu/discount-combination-cua-bundle-voi-voucher-point.md` — Discount combination của bundle với voucher/ point
- `faq/bu/mc-muon-hien-thi-widget-cua-bundle-o-trigger-product-page-product-page-cua-san-p.md` — MC muốn hiển thị widget của bundle ở Trigger product page (product page của sản phẩm con) 
...
- `faq/ppu/upsell-offer-khong-hien-o-thank-you-page.md` — Upsell offer không hiện ở Thank you page
- `faq/ppu/doi-mau-nut-cua-offer-widget.md` — Đổi màu nút của offer widget
- `faq/ppu/upsell-offer-khong-hien-o-order-status-page.md` — Upsell offer không hiện ở Order Status page
- `faq/ppu/upsell-offer-khong-hien-o-post-purchase-page.md` — Upsell offer không hiện ở Post Purchase page
- `faq/ppu/mc-thac-mac-thoi-gian-order-bi-on-hold-voi-ppu-campaign.md` — MC thắc mắc thời gian Order bị on hold với PPU campaign
- `faq/ppu/ppu-campaign-ko-work-do-ko-hien-o-checkout-shopify-settings.md` — PPU campaign ko work do ko hiện ở checkout (Shopify settings)
- `faq/ppu/show-product-meta-field-thay-cho-product-description-trong-truong-hop-product-de.md` — Show product meta field thay cho product description trong trường hợp Product description quá dài → ảnh hưởng đến layout của upsell pop up
- `faq/ppu/campaign-post-purchase-upsell-co-ho-tro-paypal-va-paypal-express-khong.md` — Campaign Post Purchase Upsell có hỗ trợ Paypal và Paypal Express không?
- `faq/ppu/an-cac-variant-khong-available-voi-style-dropdown-la-multiple-dropdown-o-variant.md` — Ẩn các variant không available với style dropdown là Multiple dropdown ở Variant picker
- `faq/ppu/typ-upsell-khong-work-voi-san-pham-upsell-la-bundle.md` — TYP upsell không work với sản phẩm upsell là bundle 
- `faq/ppu/logic-upsell-offer-san-pham-re-nhat-dat-nhat.md` — Logic Upsell offer (sản phẩm rẻ nhất/đắt nhất)
- `faq/ppu/ppu-campaign-va-shopify-pay-wallet.md` — PPU campaign và SHOPIFY_PAY wallet
- `faq/ppu/tat-ca-cac-campaign-trong-app-ppu-co-work-voi-san-pham-bundle-khong.md` — Tất cả các campaign trong app PPU có work với sản phẩm Bundle không? 
...
- `faq/cd/fix-loi-auto-open-cart-drawer.md` — Fix lỗi Auto open cart drawer
- `faq/cd/shopify-style-price-formatting.md` — Shopify-style price formatting
- `faq/cd/shipping-protection-sau-khi-add-vao-cart-ra-checkout-page-ko-thay-show.md` — Shipping protection sau khi add vào cart, ra checkout page ko thấy show
- `faq/cd/lam-tron-gia-tri-cua-pricing-trong-reward-bar.md` — Làm tròn giá trị của pricing trong Reward Bar
- `faq/cd/cho-phep-chuyen-doi-tien-te-o-reward-bar.md` — Cho phép chuyển đổi tiền tệ ở reward bar
- `faq/cd/mc-muon-dung-reward-bar-de-hien-thi-processing-widget-nhung-ko-muon-no-work-va-d.md` — MC muốn dùng reward bar để hiện thị processing widget nhưng ko muốn nó work và dùng app khác offer gift
- `faq/cd/issue-duplidated-gift-trong-cart-drawer-khi-dung-reward-bar.md` — Issue Duplidated Gift trong cart drawer khi dùng reward bar
